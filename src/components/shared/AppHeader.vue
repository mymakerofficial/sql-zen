...
<template>
  ...
  >
    <span
      class="w-96 h-full absolute left-0 -z-10 bg-gradient-to-r from-blue-500/0 via-blue-500/20 to-blue-500/0 md:from-blue-500/20 via-unset md:to-blue-500/0"
    />
    <div class="h-full flex items-center gap-3">
      <slot />
    </div>
    <Button as-child variant="ghost" class="hover:bg-primary/5 md:mr-auto">
      <RouterLink to="/">
        <span
